...
const pessoa = new Pessoa('Gustavo', 'Maxwel');
...
estudante.codigoEstudante = 2323;
estudante.nomeEstudante = 'Lebron James';
...
// Acessar os campos:
const estudante_1 = new Estudante_1(1515, 'Nikola Jokic');
console.log(
